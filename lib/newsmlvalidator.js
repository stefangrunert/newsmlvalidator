...
newsmlvalidator.controller("nmlvCtrl", function ($scope, $http) {
    ...
    $scope.options = [
        ...
        { name: "NewsML-G2 NewsMessage, containing XHTML1.0", fileName: 'urn_newsml_dpa.com_20090101_130821-96-00675.xml' },
        { name: "Invalid NewsML-G2 NewsMessage, containing XHTML1.0", fileName: 'urn_newsml_dpa.com_20090101_130821-96-00675_invalid.xml' },
        { name: "Multi-part Video in NewsML-G2 (no content set)", fileName: 'LISTING_5_Multi-part_Video_in_NewsML-G2.xml' },
        { name: "NewsItem containing NITF content", fileName: 'NewsItem_with_NITF.xml' },
        { name: "Invalid NewsItem containing NITF content", fileName: 'NewsItem_with_NITF_invalid.xml' }
    ];
